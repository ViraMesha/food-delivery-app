...
export const FeaturedItem = ({ item }: Props) => {
  const { id, name, image, description, priceSm, priceMd, priceLg } = item;
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full flex-1 hover:scale-110 trans">
        <Image src={image} alt="Pizza" fill className="object-contain" />
      </div>
      {/* Text container */}
